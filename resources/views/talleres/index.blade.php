	...
	<div class="container-fluid">
		<div class="form-head d-flex flex-wrap mb-sm-4 mb-3 align-items-center">
			<div class="me-auto  d-lg-block mb-3">
				<h2 class="text-black font-w700 mb-0">Talleres</h2>
				<p class="mb-0">Lista de Talleres </p>
			</div>
		...
		<div class="row">
			<div class="col-xl-12">
				<div class="table-responsive ">
						...
						<tbody>
                            ...
                            @foreach ($talleres as $taller)
                                <tr>
                                    ...
                                    <td class="text-center"><a href="{{ route('talleres.edit', $taller) }}" target="_blank"><i class="fa-solid fa-magnifying-glass"></i></a></td>
                                    <td>{{ $taller->nombre }}</td>
                                    <td>{{ $taller->instructor->getNombreCompletoAttribute() }}</td>
                                    <td>{{ $taller->tipo }}</td>
                            ...
                            @else
                                <tr>
                                    <td colspan="6" class="text-center"><strong>No hay talleres</strong></td>
                                </tr>
                            @endif
					...
					@if ($talleres->count())
						<div> {{ $talleres->links('pagination::bootstrap-5') }} </div>
					@endif
				</div>
			</div>
		</div>
