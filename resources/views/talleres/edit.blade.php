...
@section('content')
	...
	<div class="container-fluid">
        ...
        @endif
        <form action="{{ route('talleres.update', $taller) }}" method="POST" id="form-edit-profesor">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="card">
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                 <div class="form-group">
                                                    ...
                                                    <input type="text" name="nombre" class="form-control" placeholder="Nombre" value="{{ $taller->nombre }}" required>
                                                </div>
                                            </div>                                    
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control default-select" name="tipo" id="tipo" required>
                                                        ...
                                                        <option value="{{ $tipo }}" {{ $taller->tipo == $tipo ? 'selected' : '' }} >{{ $tipo }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>                         
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control default-select" name="estatus" id="estatus" required>
                                                        ...
                                                        <option value="{{ $estatus }}" {{ $taller ->estatus == $estatus ? 'selected' : '' }} >{{ str_replace('_',' ',$estatus) }}</option>
                                                        @endforeach
                                            ...
                                            <div class="col-md-6 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="ubicacion" class="form-control" placeholder="Ubicación" value="{{ $taller->ubicacion }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6 ">
                                                <div class="form-group">
                                                    <label class="mb-1"><strong>Cupo</strong></label>
                                                    <input type="number" name="cupo" min="1" class="form-control" placeholder="Cupo" value="{{ $taller->cupo }}" required>
                                                </div>
                                            </div>                            
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="mb-1"><strong>Semestre</strong></label>
                                                    <input type="text" name="semestre" class="form-control" placeholder="Semestre" value="{{ $taller->semestre }}">
                                                </div>
                                            </div>                                 
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control default-select" name="instructor" id="instructor" >
                                                        ...
                                                        <option value="{{ $profesor->id }}" {{ $taller->instructor == $profesor ? 'selected' : '' }} >{{ $profesor->getNombreCompletoAttribute() }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 mt-3">
                                                <div class="form-check custom-checkbox mb-3 checkbox-info">
                                                    <input type="checkbox" class="form-check-input" {{ $taller->activo ? 'checked' : '' }} id="activo" name="activo"  value="{{ $taller->activo ? true : false }}" />
                                            ...
                                            <div class="col-md-6 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="rangoInscripciones" class="form-control input-daterange-timepicker" value="{{ \Carbon\Carbon::parse($taller->fecha_inicio_inscripcion)->format('m/d/Y') . " - " . \Carbon\Carbon::parse($taller->fecha_fin_inscripcion)->format('m/d/Y') }}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ">
                                                <div class="form-group">
                                                    <label class="mb-1"><strong>Rango de Clases</strong></label>
                                                    <input type="text" name="rangoClases" class="form-control input-daterange-timepicker" value="{{ \Carbon\Carbon::parse($taller->fecha_inicio)->format('m/d/Y') . " - " . \Carbon\Carbon::parse($taller->fecha_fin)->format('m/d/Y') }}" required>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row mb-3">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="dia[]" class="form-control mdmm" required>
                                                                    @foreach ( ['Lunes','Martes','Miércoles','Jueves','Viernes','Sábado','Domingo'] as $dia )
                                                                        <option value="{{ $dia }}" 
                                                                            {{ $diaHorario['dia'] == $dia ? 'selected' : '' }}>{{ $dia }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="time" name="time-start[]" class="form-control" value="{{ $diaHorario['inicio'] }}" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="mb-1" ><strong>Hora fin</strong></label>
                                                                <input type="time" name="time-end[]" class="form-control" value="{{ $diaHorario['fin'] }}" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <span class="btn btn-danger mt-4" style=" {{ $cont > 0 ? '' : 'display:none;'}} cursor: pointer;" onclick="eliminarRenglon(this)"><i class="fa-solid fa-trash-can"></i></span>
                                                        </div>
                                                    </div>
                                                    @php $cont++ @endphp
                                                @endforeach
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea id="summernote" name="descripcion">{{ $taller->descripcion }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
