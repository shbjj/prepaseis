	...
	<div class="row">
		...
		<div class="col-xl-4 col-xxl-6 col-lg-6">
			<div class="card">
				...
				<div class="card-body p-0">
					<div id="DZ_W_TimeLine11" class="widget-timeline dz-scroll style-1  my-4 px-4 height370">
						<ul class="timeline">
							<li>
								<div class="timeline-badge primary"></div>
								<a class="timeline-panel text-muted" href="#">
			...
			<div class="card active_users">
				...
				<div class="card-body pt-0">
					<div class="list-group-flush mt-4">
						<div class="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 border-0 font-weight-semi-bold border-top-0 border-bottom">
							<p class="mb-0">top Active Pages</p>
							<p class="mb-0">Active Users</p>
						</div>
						<div class="list-group-item bg-transparent border-0 border-bottom d-flex justify-content-between px-0 py-1">
						...
						<div class="list-group-item bg-transparent d-flex border-0 border-bottom justify-content-between px-0 py-1">
			...
			<div class="card">
				...
				<div class="row">
					<div class="col-6 border-end">
						<div class="pt-3 pb-3 pl-0 pe-0 text-center">
