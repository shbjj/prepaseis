	...
	<div class="container-fluid">
		<div class="form-head d-flex flex-wrap mb-sm-4 mb-3 align-items-center">
			<div class="me-auto  d-lg-block mb-3">
				<h2 class="text-black font-w700 mb-0">Student</h2>
					...
					<table class="table table-responsive-lg mb-4 dataTablesCard card-table text-black" id="example5">
						...
						<tbody>
								...
								<td>
									<div class="media d-flex align-items-center">
										...
										<div class="media-body text-nowrap">
											<h6 class="text-black font-w600 fs-16 mb-0">Andy Lee</h6>
										</div>
									</div>
								</td>
								<td class="text-black">Mr. Johnson</td>
								<td class="text-black">London</td>
								<td>
									<div class="d-flex">
										<a class="contact-icon me-3 " href="#"><i class="fa fa-phone" aria-hidden="true"></i></a>
										<a class="contact-icon" href="#"><i class="fa fa-envelope"></i></a>
									</div>
								</td>
								<td>
									<div class="d-flex align-items-center">
										<a class="btn btn-rounded btn-success me-auto text-nowrap" href="#">VI-ABC</a>
										
									</div>
								</td>
								<td><div class="dropdown float-end custom-dropdown c-pointer mb-0">
							...
							<tr>
								...
								<td>
									<div class="media d-flex align-items-center">
										<img src="{{ asset('images/table/2.jpg')}}" class="rounded me-2" width="50" alt="">
										<div class="media-body text-nowrap">
											<h6 class="text-black font-w600 fs-16 mb-0">Brian Corner</h6>
										</div>
									</div>
								</td>
								<td class="text-black">Mr. Luke Idaman</td>
								<td class="text-black">London</td>
								<td>
									<div class="d-flex">
										<a class="contact-icon" href="#"><i class="fa fa-envelope"></i></a>
								...
								<td>
									<div class="d-flex align-items-center">
										<a class="btn btn-rounded btn-secondary me-auto text-nowrap" href="#">VI-ABC</a>
									</div>
								</td>
								<td><div class="dropdown float-end custom-dropdown c-pointer mb-0">
											<div class="" data-bs-toggle="dropdown">
							...
							<tr>
								...
								<td>
									<div class="media d-flex align-items-center">
										<img src="{{ asset('images/table/3.jpg')}}" class="rounded me-2" width="50" alt="">
										<div class="media-body text-nowrap">
											<h6 class="text-black font-w600 fs-16 mb-0">Benny Anderson</h6>
										</div>
									</div>
								</td>
								<td class="text-black">Mr. Kevin H.</td>
								<td class="text-black">Medan</td>
								<td>
									<div class="d-flex">
										<a class="contact-icon me-3 " href="#"><i class="fa fa-phone" aria-hidden="true"></i></a>
										<a class="contact-icon" href="#"><i class="fa fa-envelope"></i></a>
								...
								<td>
									<div class="d-flex align-items-center">
										<a class="btn btn-rounded btn-info me-auto text-nowrap " href="#">VI-ABC</a>
									</div>
								</td>
								<td><div class="dropdown float-end custom-dropdown c-pointer mb-0">
											<div class="" data-bs-toggle="dropdown">
							...
							<tr>
								...
								<td>
									<div class="media d-flex align-items-center">
										<img src="{{ asset('images/table/4.jpg')}}" class="rounded me-2" width="50" alt="">
										<div class="media-body text-nowrap">
											<h6 class="text-black font-w600 fs-16 mb-0">Marqueez Brownlee</h6>
										</div>
									</div>
								</td>
								<td class="text-black">Mr. Randy O.</td>
								<td class="text-black">Medan</td>
								<td>
									<div class="d-flex">
										<a class="contact-icon me-3 " href="#"><i class="lab la-whatsapp "></i></a>
									</div>
								</td>
								<td>
									<div class="d-flex align-items-center">
							...
							<tr>
								...
								<td>
									<div class="media d-flex align-items-center">
										<img src="{{ asset('images/table/5.jpg')}}" class="rounded me-2" width="50" alt="">
										<div class="media-body text-nowrap">
											<h6 class="text-black font-w600 fs-16 mb-0">Louis Simatupang</h6>
										</div>
									</div>
								</td>
								<td class="text-black">Mr. Steven</td>
								<td class="text-black">London</td>
								<td>
									<div class="d-flex">
										<a class="contact-icon me-3 " href="#"><i class="fa fa-phone" aria-hidden="true"></i></a>
								...
								<td>
									<div class="d-flex align-items-center">
										<a class="btn btn-rounded btn-danger me-auto text-nowrap " href="#">VI-ABC</a>
							...
							<tr>
								...
								<td>
									<div class="media d-flex align-items-center">
										<img src="{{ asset('images/table/6.jpg')}}" class="rounded me-2" width="50" alt="">
										<div class="media-body text-nowrap">
											<h6 class="text-black font-w600 fs-16 mb-0">Mellisa Humble</h6>
										</div>
									</div>
								</td>
								<td class="text-black">Mr. Erwin</td>
								<td class="text-black">New York</td>
								<td>
									<div class="d-flex">
										<a class="contact-icon me-3" href="#"><i class="fa fa-phone" aria-hidden="true"></i></a>
									</div>
							...
							<tr>
								...
								<td>
									<div class="media d-flex align-items-center">
										<img src="{{ asset('images/table/7.jpg')}}" class="rounded me-2" width="50" alt="">
										<div class="media-body text-nowrap">
											<h6 class="text-black font-w600 fs-16 mb-0">John Dono</h6>
										</div>
									</div>
								</td>
								<td class="text-black">Mr. Johnson</td>
								<td class="text-black">Manchester</td>
								<td>
									<div class="d-flex">
										<a class="contact-icon me-3" href="#"><i class="fa fa-phone" aria-hidden="true"></i></a>
										<a class="contact-icon" href="#"><i class="fa fa-envelope"></i></a>
							...
							<tr>
								...
								<td>
									<div class="media d-flex align-items-center">
										<img src="{{ asset('images/table/8.jpg')}}" class="rounded me-2" width="50" alt="">
										<div class="media-body text-nowrap">
											<h6 class="text-black font-w600 fs-16 mb-0">Zen Dharma</h6>
										</div>
									</div>
								</td>
								<td class="text-black">Mr. Luke Idaman</td>
							...
							<tr>
								...
								<td>
									<div class="media d-flex align-items-center">
										<img src="{{ asset('images/table/9.jpg')}}" class="rounded me-2" width="50" alt="">
										<div class="media-body text-nowrap">
											<h6 class="text-black font-w600 fs-16 mb-0">Marquz</h6>
										</div>
									</div>
								</td>
								<td class="text-black">Mr. Kevin H.</td>
