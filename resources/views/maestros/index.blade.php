	...
	<div class="container-fluid">
		<div class="form-head d-flex flex-wrap mb-sm-4 mb-3 align-items-center">
			<div class="me-auto  d-lg-block mb-3">
				<h2 class="text-black font-w700 mb-0">Profesores</h2>
				<p class="mb-0">Lista de Profesores </p>
			</div>
		...
		<div class="row">
			<div class="col-xl-12">
				<div class="table-responsive ">
						...
						<tbody>
                            ...
                            @foreach ($profesores as $profesor)
                                <tr>
                                    ...
                                    <td class="text-center"><a href="{{ route('profesores.edit', $profesor) }}" target="_blank"><i class="fa-solid fa-magnifying-glass"></i></a></td>
                                    <td>
                                        <div class="media d-flex align-items-center">
                                            <img src="{{ asset('images/table/1.jpg')}}" class="rounded me-2" width="50" alt="">
                                            <div class="media-body text-nowrap">
                                                <h6 class="text-black font-w600 fs-16 mb-0">{{ $profesor->getNombreCompletoAttribute() }}</h6>
                                            </div>
                                        </div>
                                    </td>
                            ...
                            @else
								<tr>
									<td colspan="6" class="text-center"><strong>No hay profesores</strong></td>
								</tr>
                            @endif
					...
					@if ($profesores->count())
						<div> {{ $profesores->links('pagination::bootstrap-5') }} </div>
					@endif
				</div>
			</div>
		</div>
